# Voice — Mount Horeb Optimist site
...
Imagine Jennifer Garner talking to a forty-five-year-old Mount Horeb schoolteacher. That's the voice. Warm, smart, down-to-earth — one real person speaking to another. Not a brand. Not a target audience.

Hold that picture before writing a sentence. The rules below all serve it.
...
## Don't break the voice

If a section JC asks for would require a tone shift, surface that tradeoff before writing.
